...
- The current local files yield 467 executable magical entries (276 spells, 77 rituals, 114 tricks) and 363 executable karmic entries (203 liturgies, 147 ceremonies, 13 blessings). Seeding is idempotent by Regelwiki external ID.
